      ...
      var _FirstTimeLoginPage = /*#__PURE__*/function () {
        function FirstTimeLoginPage(router, formBuilder, forgotPassService, loadingController, alertController) {
          ...
          this.form = this.formBuilder.group({
            ...
            password: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required, // Validators.pattern('(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&].{8,}')
            this.alphaNumericValidator]],
            confirm_password: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required]
          });
          this.form2 = this.formBuilder.group({
            password: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required, this.alphaNumericValidator]],
            confirm_password: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required]
          });
        }
        ...
        _createClass(FirstTimeLoginPage, [{
                      ...
                      this.forgotPassService.firstTimeLogin(this.form.value, this.user_id).subscribe(function (res) {
                        ...
                        if (res == 'email already exist') {
                          ...
                          if (_this.checked == true) {
                            localStorage.setItem('pass', _this.form.value.password);
                          } else {
                  ...
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 5:
                      ...
                      this.forgotPassService.updatePassword(this.form2.value, this.user_id).subscribe(function (res) {
                        console.log("res", res); //replace new password in local storage if remeber me is checked in the login page

                        if (_this3.checked == true) {
                          localStorage.setItem('pass', _this3.form2.value.password);
                        } else {
                          localStorage.removeItem('pass');
                        }
          ...
          value: function alphaNumericValidator(control) {
            if (control.value !== null) {
              var valueLowerCase = control.value.match('(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&]).{8,}');
              var isValid = valueLowerCase !== null; // eslint-disable-next-line no-console
          ...
          key: "toggleTextPassword2",
          value: function toggleTextPassword2() {
