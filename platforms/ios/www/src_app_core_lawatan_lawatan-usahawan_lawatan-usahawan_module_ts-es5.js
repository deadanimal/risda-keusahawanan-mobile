(function () {
  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["src_app_core_lawatan_lawatan-usahawan_lawatan-usahawan_module_ts"], {
    ...
    8032: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _LawatanUsahawanPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.IonicModule, _lawatan_usahawan_routing_module__WEBPACK_IMPORTED_MODULE_0__.LawatanUsahawanPageRoutingModule],
        declarations: [_lawatan_usahawan_page__WEBPACK_IMPORTED_MODULE_1__.LawatanUsahawanPage],
        providers: [_ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_2__.HTTP, _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_3__.File]
      })], _LawatanUsahawanPageModule);
      /***/
    },
    ...
    95861: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @ionic-native/file/ngx */
      20138); // import { FileTransfer, FileUploadOptions, FileTransferObject } from '@awesome-cordova-plugins/file-transfer/ngx';
      ...
      var _LawatanUsahawanPage = /*#__PURE__*/function () {
        function LawatanUsahawanPage(modalController, lawatanService, http, file) {
        ...
        _createClass(LawatanUsahawanPage, [{
          ...
          value: function getLawatan() {
            ...
            this.lawatanService.getLawatanUsahawan(this.user_id).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.map)(function (x) {
              ...
              console.log("res", res);
              _this2.lawatan = res; // window.location.reload();
            });
            this.lawatanService.getLawatanUsahawan(this.user_id).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.map)(function (x) {
              return x.filter(function (i) {
                return i.status_lawatan == "4";
              ...
              _this2.laporan = res; // window.location.reload();
              // this.lawatan
            });
      ...
      _LawatanUsahawanPage = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
