(function () {
  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["src_app_login_login_module_ts"], {
    ...
    80107: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      /*! ./login.page */
      66825); // import { FormsModule, Reacti } from '@angular/forms';
      ...
      var _LoginPage = /*#__PURE__*/function () {
        ...
        _createClass(LoginPage, [{
          ...
          value: function ngOnInit() {
            ...
            if (rememberMe == 'true') {
              this.checked = true;
              var nokp = localStorage.getItem('nokp');
          ...
          value: function login() {
            ...
            this.loginService.check1user(this.form.value).subscribe(function (res) {
              ...
              if (Object.keys(res).length === 0) {
                ...
                if (_this.checked == true) {
                  ...
                  localStorage.setItem('nokp', _this.form.value.no_kp);
                  localStorage.setItem('pass', _this.form.value.password);
                } else {
                  _this.loginService.setLoggedInStatus(false);
