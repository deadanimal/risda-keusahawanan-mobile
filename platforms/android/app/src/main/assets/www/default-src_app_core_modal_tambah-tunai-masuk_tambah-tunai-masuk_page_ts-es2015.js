...
let TambahTunaiMasukPage = class TambahTunaiMasukPage {
    constructor(modalController, formBuilder, kategoriAliranService, aliranService) {
    ...
    getKategoriAliran() {
        this.kategoriAliranService.getKategoriAliran().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(x => x.filter(i => i.jenis_aliran == "tunai_masuk"))).subscribe((res) => {
...
TambahTunaiMasukPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
