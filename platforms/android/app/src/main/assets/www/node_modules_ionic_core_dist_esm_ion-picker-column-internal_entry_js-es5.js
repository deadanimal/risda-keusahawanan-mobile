(function () {
  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["node_modules_ionic_core_dist_esm_ion-picker-column-internal_entry_js"], {
    /***/
    1349: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var PickerColumnInternal = /*#__PURE__*/function () {
        ...
        _createClass(PickerColumnInternal, [{
          ...
          value: function componentWillLoad() {
            ...
            var visibleCallback = function visibleCallback(entries) {
              ...
              if (ev.isIntersecting) {
                 ...
                 */
                var oldActive = (0, _helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_2__.g)(_this2.el).querySelector(".".concat(PICKER_COL_ACTIVE));
          ...
          key: "activeItem",
          get: function get() {
            return (0, _helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).querySelector(".picker-item[data-value=\"".concat(this.value, "\"]"));
          }
        }, {
          key: "render",
