...
LawatanUsahawanPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
let LawatanUsahawanPage = class LawatanUsahawanPage {
    constructor(modalController, lawatanService, http) {
    ...
    getLawatan() {
        this.lawatanService.getLawatanUsahawan(this.user_id).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.map)(x => x.filter(i => i.status_lawatan != "4"))).subscribe((res) => {
            console.log("res", res);
            this.lawatan = res;
...
LawatanUsahawanPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
