(function () {
  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["src_app_auth_profile_profile_module_ts"], {
    ...
    92855: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var sweetalert2__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_6__); // import { LoginModel } from 'src/app/services/login/login.model';


      var _ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(usahawanService, loginService, router, user, usahawan, formBuilder, loadingController) {
          ...
          this.form = this.formBuilder.group({
            Kod_PT: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            namausahawan: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            nokadpengenalan: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            tarikhlahir: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            U_Jantina_ID: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            U_Bangsa_ID: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            statusperkahwinan: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            U_Pendidikan_ID: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            ...
            bandar: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            ...
            U_Mukim_ID: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            U_Parlimen_ID: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            U_Dun_ID: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            U_Kampung_ID: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            U_Seksyen_ID: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            id_kategori_usahawan: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            // gambar_url:  ['',Validators.required]),
            notelefon: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
            nohp: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required],
                  ...
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      this.usahawanService.update(Number(this.usahawan_id), this.form.value).subscribe(function (res) {
                        console.log(res);
                        loading.dismiss();
                        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire('', 'Kemaskini Berjaya', 'success');
                      });
      ...
      _ProfilePage = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_11__.Component)({
