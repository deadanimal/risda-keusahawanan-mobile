(function () {
  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["node_modules_ionic_core_dist_esm_ion-picker-internal_entry_js"], {
    /***/
    37915: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./helpers-eed79a2b.js */
      87278);
      /*!
      ...
      var PickerInternal = /*#__PURE__*/function () {
        function PickerInternal(hostRef) {
          ...
          this.searchColumn = function (colEl, value) {
            ...
            item = colEl.items.find(function (_ref2) {
              var text = _ref2.text;
          ...
          this.selectMultiColumn = function () {
            ...
            switch (value.length) {
              ...
              case 2:
                ...
                if (value.length === 1) {
                  var _minuteValue = inputEl.value.substring(inputEl.value.length - 1);

                  _this.searchColumn(lastColumn, _minuteValue, 'end');
                }
              ...
              case 3:
                ...
                var minuteValue = value.length === 1 ? inputEl.value.substring(1) : inputEl.value.substring(2);
