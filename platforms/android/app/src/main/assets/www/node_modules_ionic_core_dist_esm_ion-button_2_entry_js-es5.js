(function () {
  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["node_modules_ionic_core_dist_esm_ion-button_2_entry_js"], {
    /***/
    30392: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var getNamedUrl = function getNamedUrl(iconName) {
        ...
        return (0, _index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.k)("svg/".concat(iconName, ".svg"));
      };
        ...
        function Button(hostRef) {
          ...
          this.handleClick = function (ev) {
            if (_this.type === 'button') {
              (0, _theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_3__.o)(_this.href, ev, _this.routerDirection, _this.routerAnimation);
            } else if ((0, _helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_2__.l)(_this.el)) {
        ...
        _createClass(Button, [{
          ...
          value: function render() {
            ...
            return (0, _index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__.H, {
              ...
              "class": (0, _theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_3__.c)(color, (_ref = {}, _defineProperty(_ref, mode, true), _defineProperty(_ref, buttonType, true), _defineProperty(_ref, "".concat(buttonType, "-").concat(expand), expand !== undefined), _defineProperty(_ref, "".concat(buttonType, "-").concat(finalSize), finalSize !== undefined), _defineProperty(_ref, "".concat(buttonType, "-").concat(shape), shape !== undefined), _defineProperty(_ref, "".concat(buttonType, "-").concat(fill), true), _defineProperty(_ref, "".concat(buttonType, "-strong"), strong), _defineProperty(_ref, 'in-toolbar', (0, _theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_3__.h)('ion-toolbar', this.el)), _defineProperty(_ref, 'in-toolbar-color', (0, _theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_3__.h)('ion-toolbar[color]', this.el)), _defineProperty(_ref, 'button-has-icon-only', hasIconOnly), _defineProperty(_ref, 'button-disabled', disabled), _defineProperty(_ref, 'ion-activatable', true), _defineProperty(_ref, 'ion-focusable', true), _ref))
