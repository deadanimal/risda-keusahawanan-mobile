  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["default-src_app_core_buletin_kemaskini-buletin_kemaskini-buletin_page_ts"], {
    ...
    21318: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _KemaskiniBuletinPage = /*#__PURE__*/function () {
        function KemaskiniBuletinPage(modalController, formBuilder, buletinService, alertController, loadingController) {
          ...
          this.loadingController = loadingController; // Convert the base64 to blob data
        ...
        _createClass(KemaskiniBuletinPage, [{
          ...
          value: function setFormValues() {
            var date = moment__WEBPACK_IMPORTED_MODULE_3__(this.buletin.tarikh).format('YYYY-MM-DD');
                                ...
                                while (1) {
                                  switch (_context.prev = _context.next) {
                                    ...
                                    case 3:
                                      ...
                                      this.buletinService.update(this.form.value, this.buletin.id).subscribe(function (res) {
                                        console.log("updated data", res);
                                        loading.dismiss(); // this.dismiss();
          ...
          value: function onSelectFile(event) {
            ...
            if (event.target.files && event.target.files[0]) {
              ...
              reader.onload = function (event) {
                _this3.url = event.target.result;
              };
      ...
      _KemaskiniBuletinPage.propDecorators = {
        buletin: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_7__.Input
        }]
      };
      _KemaskiniBuletinPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
