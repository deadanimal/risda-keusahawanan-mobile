...
let KemaskiniTunaiKeluarPage = class KemaskiniTunaiKeluarPage {
    ...
    getKategoriAliran() {
        this.kategoriAliranService.getKategoriAliran().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(x => x.filter(i => i.jenis_aliran == "tunai_keluar"))).subscribe((res) => {
...
KemaskiniTunaiKeluarPage.propDecorators = {
    tunai_keluar: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_10__.Input }]
};
KemaskiniTunaiKeluarPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
