...
let ProfilePage = class ProfilePage {
            ...
            this.usahawanService.show(this.usahawan_id).subscribe((res) => {
                ...
                if (Object.keys(res).length === 0) {
                    ...
                    this.negeriService.get().subscribe((resNegeri) => {
                        ...
                        this.daerahService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Negeri_ID == this.usahawan.U_Negeri_ID))).subscribe((resDaerah) => {
                            console.log("resDaerah", resDaerah);
                            this.daerah = resDaerah;
                            this.mukimService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Daerah_ID == this.usahawan.U_Daerah_ID))).subscribe((resMukim) => {
                                console.log("resMukim", resMukim);
                                this.mukim = resMukim;
                                this.parlimenService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Negeri_ID == this.usahawan.U_Negeri_ID))).subscribe((resParlimen) => {
                                    console.log("resParlimen", resParlimen);
                                    this.parlimen = resParlimen;
                                    this.dunService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Parlimen_ID == this.usahawan.U_Parlimen_ID))).subscribe((resDun) => {
                                        console.log("resDun", resDun);
                                        this.dun = resDun;
                                        this.kampungService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Mukim_ID == this.usahawan.U_Mukim_ID))).subscribe((resKampung) => {
                                            ...
                                            this.seksyenService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Mukim_ID == mukimStr))).subscribe((resSeksyen) => {
    ...
    getPT() {
        this.ptService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.Kod_PT == this.usahawan.Kod_PT))).subscribe((res) => {
            // console.log("pt", res);
    ...
    getDaerah() {
        this.daerahService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Negeri_ID == this.form.value.U_Negeri_ID))).subscribe((res) => {
            console.log("Daerah", res);
            this.daerah = res;
        });
    }
    getMukim() {
        this.mukimService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Daerah_ID == this.form.value.U_Daerah_ID))).subscribe((res) => {
            console.log("mukim", res);
            this.mukim = res;
        });
    }
    getParlimen() {
        this.parlimenService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Negeri_ID == this.form.value.U_Negeri_ID))).subscribe((res) => {
            console.log("parlimen", res);
            this.parlimen = res;
        });
    }
    getDun() {
        this.dunService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Parlimen_ID == this.form.value.U_Parlimen_ID))).subscribe((res) => {
            console.log("dun", res);
            this.dun = res;
        });
    }
    getKampung() {
        this.kampungService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Mukim_ID == this.form.value.U_Mukim_ID))).subscribe((res) => {
    ...
    getSeksyen() {
        ...
        this.seksyenService.get().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.U_Mukim_ID == mukim))).subscribe((res) => {
    ...
    getAliranJualan() {
        this.aliranService.get(this.user_id).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.map)(x => x.filter(i => i.kategori_aliran == "JUALAN/PEROLEHAN"))).subscribe((res) => {
    ...
    calcBirthDate() {
        ...
        const datepipe = new _angular_common__WEBPACK_IMPORTED_MODULE_20__.DatePipe('en-US');
        this.form.patchValue({
