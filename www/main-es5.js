  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["main"], {
    ...
    90158: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() */
          [__webpack_require__.e("default-node_modules_moment_moment_js"), __webpack_require__.e("default-src_app_core_buletin_kemaskini-buletin_kemaskini-buletin_page_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_core_buletin_buletin_buletin_module_ts")]).then(__webpack_require__.bind(__webpack_require__,
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() */
          [__webpack_require__.e("default-node_modules_moment_moment_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_core_buletin_tambah-buletin_tambah-buletin_module_ts-src_app_services_buletin_buletin-0fd5e5")]).then(__webpack_require__.bind(__webpack_require__,
      ...
      var _AppComponent = /*#__PURE__*/function () {
        function AppComponent(router, pegawaiService, usahawanService, notiService) {
          ...
          this.appPages = [{
            title: 'Profil',
            url: '/profile',
            icon: 'assets/new-icon/Profil.png'
          }, {
            title: 'Insentif',
            url: '/insentif',
            icon: 'assets/new-icon/Insentif.png'
          }, {
            title: 'Aliran Tunai',
            url: '/aliran-tunai',
            icon: 'assets/new-icon/Aliran-Tunai.png'
          }, {
            title: 'Buku tunai',
            url: '/buku-tunai',
            icon: 'assets/new-icon/Buku-Tunai.png'
          }, {
            title: 'Ringkasan lejar',
            url: '/ringkasan-lejar',
            icon: 'assets/new-icon/Ringkasan-Lejar.png'
          }, {
            title: 'Penyata Untung Rugi',
            url: '/pnl',
            icon: 'assets/new-icon/Penyata-Untung-Rugi.png'
          }, {
            title: 'Katalog',
            url: 'katalog',
            icon: 'assets/new-icon/Katalog.png'
          }, {
            title: 'Jana Dokumen',
            url: '/jana-dokumen',
            icon: 'assets/new-icon/Jana-Dokumen.png'
          }, {
            title: 'Lawatan',
            url: 'lawatan-usahawan',
            icon: 'assets/new-icon/Lawatan.png'
          } // { title: 'Log Keluar',  url: '#', icon: 'assets/new-icon/log-out-button.png' },
          ];
          this.appPagesPegawai = [{
            title: 'Carian',
            url: '/carian',
            icon: 'assets/new-icon/Carian.png'
          }, {
            title: 'Lawatan',
            url: '/lawatan-pegawai',
            icon: 'assets/new-icon/Lawatan.png'
          ...
          value: function ngOnInit() {
            ...
            if (this.peranan_pegawai == "1") {
              this.appPagesPegawai.push({
                title: 'Buletin',
                url: '/buletin',
                icon: 'assets/new-icon/Buletin.png'
              });
            }
          }
        }, {
    ...
    36747: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _AppModule = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.NgModule)({
        ...
        }, _services_login_login_service__WEBPACK_IMPORTED_MODULE_2__.LoginService, _angular_common_http__WEBPACK_IMPORTED_MODULE_11__.HttpClientModule, _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_5__.Geolocation, _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_6__.NativeGeocoder, {
          provide: _angular_router__WEBPACK_IMPORTED_MODULE_14__.RouteReuseStrategy,
          useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_10__.IonicRouteStrategy
        }],
