                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            return (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(_this2, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                              ...
                              var temp, temp2, loading;
                              return regeneratorRuntime.wrap(function _callee$(_context) {
                                while (1) {
                                  switch (_context.prev = _context.next) {
                                    case 0:
                                      console.log('Confirm Okay');
                                      this.form.value.tarikh_aliran = moment__WEBPACK_IMPORTED_MODULE_3__(this.form.value.tarikh_aliran).format('YYYY-MM-DD'); // this.form.value.status_katalog 

                                      // this.form.value.status_katalog 
                                      temp = this.form.value.nama_produk.toUpperCase();
                                      temp2 = this.form.value.kandungan_produk.toUpperCase();
                    ...
                    case 0:
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          text: 'Ya',
                          handler: function handler() {
                            return (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(_this4, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
                              var _this5 = this;
          ...
          value: function onSelectFile(event) {
            ...
            if (event.target.files && event.target.files[0]) {
              ...
              reader.onload = function (event) {
                _this6.katalog.gambar_url = event.target.result;
              };
