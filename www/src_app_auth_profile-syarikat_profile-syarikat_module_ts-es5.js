  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["src_app_auth_profile-syarikat_profile-syarikat_module_ts"], {
    ...
    51117: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ProfileSyarikatPage = /*#__PURE__*/function () {
        function ProfileSyarikatPage(syarikatService, loginService, router, syarikat, alertController, loadingController, formBuilder) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      loading.present();
                      console.log(this.form.value);
                      this.syarikatService.update(this.form.value, Number(this.usahawan_id)).subscribe(function (res) {
      ...
      _ProfileSyarikatPage = (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
