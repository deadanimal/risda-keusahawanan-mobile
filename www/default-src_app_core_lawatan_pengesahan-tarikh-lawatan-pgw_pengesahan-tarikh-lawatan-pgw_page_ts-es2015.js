...
let PengesahanTarikhLawatanPgwPage = class PengesahanTarikhLawatanPgwPage {
    constructor(modalController, formBuilder, loadingController, alertController, router, lawatanService) {
    ...
    logForm() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            ...
            // }
            this.form.value.tarikh_lawatan = moment__WEBPACK_IMPORTED_MODULE_3__(this.form.value.tarikh_lawatan).format('YYYY-MM-DD');
            ...
            let tempDate = moment__WEBPACK_IMPORTED_MODULE_3__(this.form.value.tarikh_lawatan).format('DD/MM/YYYY');
    ...
    sahkan() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            ...
            console.log(this.form.value);
            let tempDate = moment__WEBPACK_IMPORTED_MODULE_3__(this.lawatan.tarikh_lawatan).format('DD/MM/YYYY');
            const alert = yield this.alertController.create({
                cssClass: 'my-custom-class',
                header: '',
...
PengesahanTarikhLawatanPgwPage.propDecorators = {
    lawatan: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.Input }]
};
