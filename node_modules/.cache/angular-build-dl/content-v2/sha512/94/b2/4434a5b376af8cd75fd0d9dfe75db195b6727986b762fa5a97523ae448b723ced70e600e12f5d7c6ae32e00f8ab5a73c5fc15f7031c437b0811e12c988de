  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["default-src_app_core_modal_tambah-tunai-masuk_tambah-tunai-masuk_page_ts"], {
    ...
    29309: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _TambahTunaiMasukPage = /*#__PURE__*/function () {
        function TambahTunaiMasukPage(modalController, formBuilder, kategoriAliranService, aliranService) {
          ...
          this.tunai_masuk = this.formBuilder.group({
            id_pengguna: [''],
            id_kategori_aliran: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required],
            tarikh_aliran: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required],
            keterangan_aliran: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required],
            jumlah_aliran: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required],
            dokumen_lampiran: ['']
          });
        }
        ...
        _createClass(TambahTunaiMasukPage, [{
          ...
          value: function getKategoriAliran() {
            ...
            this.kategoriAliranService.getKategoriAliran().pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(function (x) {
              return x.filter(function (i) {
                return i.jenis_aliran == "tunai_masuk";
              });
            })).subscribe(function (res) {
              console.log("kategori aliran", res);
              _this.kategori_aliran_masuk = res;
              console.log("kategori aliran", _this.kategori_aliran_masuk);
            });
          }
        }, {
          key: "handleFileInput",
      ...
      _TambahTunaiMasukPage = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
